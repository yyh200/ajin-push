...
- 博时黄金ETF联接C 002611 → 实物黄金(~32.0%)
- 东方人工智能主题混合C 017811 → 🔴 实际=半导体设备100%(~22.1%)
- 华夏电网设备ETF联接C 025857 → 电网设备(~13.5%)
- 易方达云计算ETF联接C 017854 → 云计算/AI算力(~8.1%)
- 华夏人工智能ETF联接C 008586 → AI指数ETF(~4.6%)
- 华夏中证5G通信ETF联接C 008087 → ⚠️ 实际=CPO(~50%)+PCB(~30%)(~3.9%)
- 南方纳斯达克100QDII C 016453 → 美股科技指数(~2.1%)
- 已清仓：南方有色金属ETF 512400（❌ 6/26清仓）
- 现金 ~13.6%

🔴 穿透后真实结构：黄金32% + 科技链52%（半导体+云+AI+5G+纳指）+ 电网14%
